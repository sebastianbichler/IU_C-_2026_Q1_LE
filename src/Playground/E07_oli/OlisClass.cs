internal class OlisClass
{
    public bool IstSchaltjahr(int jahr)
    {
        Console.Clear();
        Console.WriteLine($"IstSchaltjahr für das Jahr {jahr}:");
        ...
        if (jahr % 400 == 0)
        {
            Console.WriteLine("Das Jahr ist ein Schaltjahr, da es durch 400 teilbar ist.");
            return true;
        }

        if (jahr % 100 == 0)
        {
            Console.WriteLine("Das Jahr ist kein Schaltjahr, da es durch 100 teilbar ist.");
            return false;
        }

        if (jahr % 4 == 0)
        {
            Console.WriteLine("Das Jahr ist ein Schaltjahr, da es durch 4 teilbar ist.");
            return true;
        }

        Console.WriteLine("Das Jahr ist kein Schaltjahr, da es nicht durch 4 teilbar ist.");
        return false;
    }
